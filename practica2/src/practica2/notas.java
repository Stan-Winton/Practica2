...
public class notas {
    ...
    public void ingresarNotas() {
        ...
        notaUnidadFormativa1 = entrada.nextDouble();
        System.out.print("Ingrese nota 2: ");
        notaUnidadFormativa2 = entrada.nextDouble();
        System.out.print("Ingrese nota 3: ");
        notaUnidadFormativa3 = entrada.nextDouble();
    }

    /**
     * Método para comprobar si las notas ingresadas son correctas.
     * <p>
     * Este método verifica si las notas ingresadas son menores o iguales a 10.
     * Si alguna nota es mayor a 10, se muestra un mensaje indicando que la nota fue mal introducida.
     * </p>
     */
    public void comprobarNotas() {
        comprobarNota(notaUnidadFormativa1, "1");
        comprobarNota(notaUnidadFormativa2, "2");
        comprobarNota(notaUnidadFormativa3, "3");
    }

    private void comprobarNota(double nota, String notaNumero) {
        if (nota > 10) {
            System.out.println("Nota " + notaNumero + " mal introducida");
        } else {
            System.out.println("Nota " + notaNumero + " correcta");
        }
    }
